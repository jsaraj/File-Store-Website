...
const BlogBoxRelated = () => {
    return (
        <Link href="#">
            <div className=" relative w-[250px] sm:h-[400px] h-[480px] bg-zinc-50 rounded-md overflow-hidden hover:-translate-y-2 transition-all duration-200 p-2 border ">
                <Image
                ...
                <div className="h-1 bg-orange-200 w-[90%] mx-auto mt-2 rounded-md"></div>
