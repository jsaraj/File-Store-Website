...
const MiddleBannerForm = () => {
    ...
    const [detail, setDetail] = useState(<AllMidBanner setMidBanDetail={setMidBanDetail} setRandNnumberForBannerDetail={setRandNnumberForBannerDetail} />)
