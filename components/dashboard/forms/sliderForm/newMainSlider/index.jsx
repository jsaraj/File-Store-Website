...
const NewMainSlider = () => {
    ...
    const submmiter = (e) => {
        ...
        axios.post("http://localhost:27017/api/new-main-slider", formData)
            .then(d => {
                ...
                <div>
                    <form onSubmit={submmiter} className="flex flex-col gap-5">
                        <div className="w-full flex flex-col gap-2">
                            ...
                            <input required ref={imageSrcRef} type="text" className="inputLtr p-2 outline-none rounded-md w-full border-gray-200 border" />
                        </div>
                        <div className="w-full flex flex-col gap-2">
                            <label >آلت عکس</label>
